...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "training_job_id",
            UuidType,
            sa.ForeignKey("modeling.training_jobs.id", ondelete="CASCADE"),
        ),
    ...
    op.create_index(
        "ix_hpo_jobs_organization_id", "optimization_jobs", ["organization_id"], schema="hpo"
    )
    op.create_index(
        "ix_hpo_jobs_training_job_id", "optimization_jobs", ["training_job_id"], schema="hpo"
    )
    op.create_index(
        "ix_hpo_jobs_feature_set_id", "optimization_jobs", ["feature_set_id"], schema="hpo"
    )
    ...
    op.create_table(
        ...
        sa.Column("organization_id", UuidType, nullable=False),
        sa.Column(
            "job_id", UuidType, sa.ForeignKey("hpo.optimization_jobs.id", ondelete="CASCADE")
        ),
        ...
        sa.Column("best_score", sa.Float(), nullable=True),
        sa.Column(
            "best_params_json", JsonType, nullable=False, server_default=sa.text("'{}'::json")
        ),
    ...
    op.create_index(
        "ix_hpo_studies_organization_id", "optimization_studies", ["organization_id"], schema="hpo"
    )
    ...
    op.create_table(
        ...
        sa.Column("organization_id", UuidType, nullable=False),
        sa.Column(
            "study_id", UuidType, sa.ForeignKey("hpo.optimization_studies.id", ondelete="CASCADE")
        ),
        ...
        sa.Column(
            "user_attrs_json", JsonType, nullable=False, server_default=sa.text("'{}'::json")
        ),
    ...
    op.create_index(
        "ix_hpo_trials_organization_id", "optimization_trials", ["organization_id"], schema="hpo"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "trial_id", UuidType, sa.ForeignKey("hpo.optimization_trials.id", ondelete="CASCADE")
        ),
    ...
    op.create_index(
        "ix_hpo_configs_organization_id", "optimization_configs", ["organization_id"], schema="hpo"
    )
    ...
    op.create_index(
        "ix_hpo_metrics_organization_id", "optimization_metrics", ["organization_id"], schema="hpo"
    )
    ...
    op.create_index(
        "ix_hpo_artifacts_organization_id",
        "optimization_artifacts",
        ["organization_id"],
        schema="hpo",
    )
    op.create_index(
        "ix_hpo_artifacts_study_id", "optimization_artifacts", ["study_id"], schema="hpo"
    )
    ...
    op.create_index(
        "ix_hpo_logs_organization_id", "optimization_logs", ["organization_id"], schema="hpo"
    )
    ...
    op.create_table(
        ...
        sa.Column("algorithm", sa.String(length=128), nullable=False),
        sa.Column(
            "search_space_json", JsonType, nullable=False, server_default=sa.text("'{}'::json")
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        "ix_hpo_search_spaces_organization_id", "search_spaces", ["organization_id"], schema="hpo"
    )
    ...
    op.create_index(
        "ix_hpo_tags_organization_id", "optimization_tags", ["organization_id"], schema="hpo"
    )
