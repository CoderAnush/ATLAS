...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_training_jobs_organization_id", "training_jobs", ["organization_id"], schema="modeling"
    )
    op.create_index(
        "ix_training_jobs_feature_set_id", "training_jobs", ["feature_set_id"], schema="modeling"
    )
    op.create_index(
        "ix_training_jobs_dataset_id", "training_jobs", ["dataset_id"], schema="modeling"
    )
    ...
    op.create_table(
        ...
        sa.Column("organization_id", UuidType, nullable=False),
        sa.Column(
            "job_id", UuidType, sa.ForeignKey("modeling.training_jobs.id", ondelete="CASCADE")
        ),
    ...
    op.create_index(
        "ix_trained_models_organization_id",
        "trained_models",
        ["organization_id"],
        schema="modeling",
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "trained_model_id",
            UuidType,
            sa.ForeignKey("modeling.trained_models.id", ondelete="CASCADE"),
        ),
    ...
    op.create_index(
        "ix_model_versions_organization_id",
        "model_versions",
        ["organization_id"],
        schema="modeling",
    )
    op.create_index(
        "ix_model_versions_trained_model_id",
        "model_versions",
        ["trained_model_id"],
        schema="modeling",
    )
    ...
    op.create_index(
        "ix_training_metrics_organization_id",
        "training_metrics",
        ["organization_id"],
        schema="modeling",
    )
    op.create_index(
        "ix_training_metrics_model_id", "training_metrics", ["trained_model_id"], schema="modeling"
    )
    op.create_index(
        "ix_training_metrics_name", "training_metrics", ["metric_name"], schema="modeling"
    )
    ...
    op.create_index(
        "ix_training_artifacts_organization_id",
        "training_artifacts",
        ["organization_id"],
        schema="modeling",
    )
    op.create_index(
        "ix_training_artifacts_model_id",
        "training_artifacts",
        ["trained_model_id"],
        schema="modeling",
    )
    ...
    op.create_index(
        "ix_training_configs_organization_id",
        "training_configs",
        ["organization_id"],
        schema="modeling",
    )
    ...
    op.create_index(
        "ix_training_lineage_organization_id",
        "training_lineage",
        ["organization_id"],
        schema="modeling",
    )
    op.create_index(
        "ix_training_lineage_model_id", "training_lineage", ["trained_model_id"], schema="modeling"
    )
    op.create_index(
        "ix_training_lineage_dataset_id", "training_lineage", ["dataset_id"], schema="modeling"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "supports_problem_types", JsonType, nullable=False, server_default=sa.text("'[]'::json")
        ),
    ...
    op.create_index(
        "ix_algorithm_registry_name", "algorithm_registry", ["name"], unique=True, schema="modeling"
    )
    ...
    op.create_index(
        "ix_training_logs_organization_id", "training_logs", ["organization_id"], schema="modeling"
    )
    ...
    op.create_index(
        "ix_model_tags_organization_id", "model_tags", ["organization_id"], schema="modeling"
    )
