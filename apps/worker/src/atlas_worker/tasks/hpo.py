...
@celery_app.task(name="atlas.worker.hpo", bind=True, max_retries=3)  # type: ignore[untyped-decorator]
def run_hpo_job(self: Any, job_id: str) -> dict[str, str]:
